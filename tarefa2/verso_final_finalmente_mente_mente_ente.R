...
write.xlsx(x, file="Output2_Tarefa2_4.xlsx", sheetName="Sheet1", row.names=FALSE, col.names = FALSE)
write.xlsx(y, file="Output2_Tarefa2_4.xlsx", sheetName="Sheet2", append=TRUE, row.names=FALSE, col.names = FALSE)
write.xlsx(z, file="Output2_Tarefa2_4.xlsx", sheetName="Sheet3", append=TRUE, row.names=FALSE, col.names = FALSE)
